...
class SetGUI(tk.Toplevel):
    ...
    def controls_set(self):
        ...
        self.public_page_label = tk.Label(self.bg_label, image=self.imageLoader.get_image("bg2"), compound="center",
                                          bd=0)
        public_label_1 = tk.Label(self.public_page_label, text="公共翻译接口可能会因网站变动、被反爬导致失效",
                                  font=self.font12, fg="#33ccff")
        ...
        language_label_2 = tk.Label(self.language_page_label, text="快速切换语言，可选三种", font=self.font12, fg="#33ccff")
        language_label_3 = tk.Label(self.language_page_label, text="方便起见，未写控件记忆，下次打开设置\n勾选会消失，但选择会被记录",
                                    font=self.font12, fg="#33ccff")
        ...
        language_label_3.place(x=20, y=350)
        ...
        self.other_page_label = tk.Label(self.bg_label, image=self.imageLoader.get_image("bg2"), compound="center",
                                         bd=0)
        other_label_1 = tk.Label(self.other_page_label, text="暂时没有", font=self.font12, fg="#33ccff")
